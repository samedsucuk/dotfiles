...
if exists("g:hybrid_reduced_contrast") && g:hybrid_reduced_contrast == 1
  let s:gui_background = "#293338"
  let s:gui_selection  = "#30aefc"
  let s:gui_line       = "#394954"
...
let s:palette.gui.red        = { 'dark' : "#ff9191"        , 'light' : "#5f0000" }
let s:palette.gui.orange     = { 'dark' : "#ffc29e"        , 'light' : "#875f00" }
let s:palette.gui.yellow     = { 'dark' : "#96e7ff"        , 'light' : "#5f5f00" }
let s:palette.gui.green      = { 'dark' : "#88ff75"        , 'light' : "#005f00" }
let s:palette.gui.aqua       = { 'dark' : "#8df2e5"        , 'light' : "#005f5f" }
let s:palette.gui.blue       = { 'dark' : "#7fc1fa"        , 'light' : "#00005f" }
let s:palette.gui.purple     = { 'dark' : "#dfb7eb"        , 'light' : "#5f005f" }
let s:palette.gui.window     = { 'dark' : "#474747"        , 'light' : "#9e9e9e" }
let s:palette.gui.darkcolumn = { 'dark' : "#303030"        , 'light' : "#808080" }
let s:palette.gui.addbg      = { 'dark' : "#84e884"        , 'light' : "#d7ffd7" }
